...
type ServerInfo struct {
	...
	ServerType   int    `json:"servertype" form:"-"`
	Environment  int    `json:"environment" form:"-"`
	Visibility   int    `json:"visibility" form:"-"`
	VAC          int    `json:"vac" form:"-"`
	Version      string `json:"version" form:"-"`
	Port         int    `json:"port" form:"-"`
	SteamID      int    `json:"steamid" form:"-"`
	SourceTVPort int    `json:"sourcetvport" form:"-"`
	SourceTVName string `json:"sourcetvname" form:"-"`
	Keywords     string `json:"keywords" form:"-"`
	GameID       int    `json:"gameid" form:"-"`
}
